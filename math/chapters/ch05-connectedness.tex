...
\begin{remark}
  ...
  由\cref{exr:open-iff-complement-closed}，\(F_{2} = X \setminus F_{1}\) 闭等价于
  \(F_{1}\) 开。Pugh 即从「都开」出发定义。
  下面的刻画把这件事写明。
\end{remark}
...
\begin{proof}
  ...
  而它们在 \(I\) 中互为补集，由\cref{exr:open-iff-complement-closed} 故各自也闭。
  于是它们构成 \(I\) 的 separation，\(I\) 不连通。
